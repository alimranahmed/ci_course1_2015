	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php foreach($users as $user): ?>
				<tr>
					<td><img style="widht: 50px; height:50px; " src="<?php echo base_url($user->photo); ?>" ></td>
				...
				<div class="modal fade" id="model<?php echo $user->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <form method="post" action="<?php echo site_url('user/edit/'.$user->id)?>" enctype="multipart/form-data">
